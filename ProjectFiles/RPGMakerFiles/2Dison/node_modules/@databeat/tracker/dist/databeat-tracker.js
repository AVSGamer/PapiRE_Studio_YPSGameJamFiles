...
var DatabeatRpcClient = (_class2 = class extends Databeat {
  ...
  __init7() {this._fetch = (input, init) => {
    if (this.auth) {
      let headers = {};
      if (_optionalChain([this, 'access', _4 => _4.auth, 'access', _5 => _5.jwt, 'optionalAccess', _6 => _6.length]) > 0) {
...
var isAuthEnabled = (auth) => {
  if (_optionalChain([auth, 'optionalAccess', _7 => _7.jwt, 'optionalAccess', _8 => _8.length]) > 0) {
    return true;
  }
  if (_optionalChain([auth, 'optionalAccess', _9 => _9.headers]) && Object.keys(auth.headers).length > 0) {
    return true;
  }
  return false;
};
