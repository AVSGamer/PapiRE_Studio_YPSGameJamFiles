...
const parseChunks = function _parseChunks(parser, source, helper) {
    ...
    while (match) {
        ...
        re.lastIndex = helper.flushLine(match.index, re.lastIndex, 
        //@todo I think this is the only spot we can extract found exprs and
        // share them upstream to the helper.
        // The best solution may be to add a callback function to the parse method
        // and assign it here.
        parser.parse(match, (expr) => helper.addFoundExpr(expr)));
