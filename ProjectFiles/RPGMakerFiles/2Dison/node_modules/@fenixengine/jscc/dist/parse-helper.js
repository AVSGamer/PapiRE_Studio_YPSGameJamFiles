...
const remap_vars_1 = __importDefault(require("./remap-vars"));
/**
...
class ParseHelper {
    ...
    commit(start, end) {
        ...
        return chunk.indexOf('$_') > -1 && remap_vars_1.default(this.props, chunk, start);
    }
    /**
    ...
    addFoundExpr(expr) {
        ...
        this.exprsFound.set(expr, (this.exprsFound.get(expr) || 0) + 1);
    }
    getFoundExprs() {
        return this.exprsFound;
    }
}
