...
const sendTransactions = async ({ chainId, senderAddress, publicClient, walletClient, connector, transactions, transactionConfirmations = constants_1.TRANSACTION_CONFIRMATIONS_DEFAULT, waitConfirmationForLastTransaction = true }) => {
    ...
    if (isEmbeddedWallet) {
        ...
        const wallet = _0xsequence_1.sequence.getWallet();
