...
export type { Wallet, WalletField, WalletProperties, WalletType, DisplayedAsset, ExtendedConnector, EthAuthSettings, Theme, ModalPosition, KitConfig, StorageItem } from './types';
...
export { getDefaultConnectors, getDefaultWaasConnectors, getDefaultUniversalConnectors, type DefaultConnectorOptions, type DefaultWaasConnectorOptions, type DefaultUniversalConnectorOptions } from './config/defaultConnectors';
